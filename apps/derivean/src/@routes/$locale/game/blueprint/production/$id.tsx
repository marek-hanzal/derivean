...
import { z } from "zod";
import { BlueprintProductionIndexMenu } from "~/app/game/BlueprintProductionIndexMenu";
import { BlueprintProductionPreview } from "~/app/game/BlueprintProductionPreview";

export const Route = createFileRoute("/$locale/game/blueprint/production/$id")({
