...
import type { QueuePanel } from "~/app/game/GameMap2/Production/Queue/QueuePanel";
...
export const Item: FC<Item.Props> = ({ queue, inventory }) => {
	...
	return (
		<div className={tvc(["flex", "flex-col", "gap-2", "items-center", "justify-between", "border", "p-4", "rounded-sm", "border-slate-200", "hover:border-slate-300", isFull ? ["border-red-400", "hover:border-red-600"] : undefined])}>
