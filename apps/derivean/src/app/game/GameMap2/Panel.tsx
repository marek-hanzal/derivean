...
import { PanelCss } from "~/app/game/GameMap2/PanelCss";
...
export const Panel: FC<Panel.Props> = ({ icon, textTitle, textSubTitle, variant, tva = PanelCss, css, children }) => {
		...
		<div className={tv.base()}>
			<div className={tv.title()}>
				<div className={"flex flex-col gap-2 font-bold"}>
					...
					{textSubTitle ? <div className={"flex flex-row gap-2 items-center text-sm text-slate-500"}>{textSubTitle}</div> : null}
				</div>
				<LinkTo
