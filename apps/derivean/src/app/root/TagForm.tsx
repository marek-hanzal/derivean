...
import { Button, FormCss, FormError, FormInput, onSubmit, TagIcon, Tx, type Form } from "@use-pico/client";
...
export const TagForm: FC<TagForm.Props> = ({ mutation, defaultValues, variant, tva = FormCss, css }) => {
